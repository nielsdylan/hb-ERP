...
<body>
    <div class="container">
        <div id="img-pdf" class="border-pdf">
            <div class="text-right margin-top-10"><span class="border-number margin-right-20" style="font-size: 12px !import; color: #00000059 !import;font-family: 'Roboto', normal;">N&deg;: {{$number}}</span></div>
